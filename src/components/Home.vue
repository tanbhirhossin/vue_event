<template>
  <section id="intro">
    <div class="intro-container wow fadeIn">
      <h1 class="mb-4 pb-0">Tushar Event Managenent</h1>
      <p class="mb-4 pb-0"> Downtown Conference Center, Dhaka</p>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>NVIT, 2NO Gate, Chittagong</address>
            </div>
          </div>
